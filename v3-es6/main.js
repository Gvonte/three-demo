import Gvo from "./src/gvo"; // 引入 Gvo 这个类
import commonFn from "./src/js/common"; // 扩展 Gvo 类的属性
import createFn from "./src/js/create"; // 扩展 Gvo 类的方法

commonFn(Gvo);
createFn(Gvo);

import groupCommonFn from "./src/group/groupCommon"; // 分组间公用的部分
import sceneGroup1Fn from "./src/group/sceneGroup1"; // 第一个分组
import sceneGroup2Fn from "./src/group/sceneGroup2"; // 第二个分组
import normalSceneGroupFn from "./src/group/normalSceneGroup"; // 第三个分组，另一个场景 normalScene 的内容

import {
  createComposer,
  darkenNonBloomed,
  restoreMaterial,
} from "./src/composer/composer"; // 后期处理函数
