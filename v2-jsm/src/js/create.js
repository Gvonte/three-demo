// create_fn.js
const { Group, Shape, Layers, ShapeBufferGeometry, SphereBufferGeometry, MeshBasicMaterial, Mesh, CylinderBufferGeometry, BufferGeometry, LineBasicMaterial, LineSegments, EdgesGeometry, Line, Vector3, CurvePath, LineCurve3, TubeGeometry, TextBufferGeometry, Font, CanvasTexture, SpriteMaterial, Sprite, ExtrudeGeometry, RepeatWrapping, DoubleSide, NearestFilter } = require('../lib/three.module');
const { DRACOLoader } = require('../lib/DRACOLoader');
const { GLTFLoader } = require('../lib/GLTFLoader');
const { TTFLoader } = require('../lib/TTFLoader')
const html2canvas = require('../lib/html2canvas.min');
const { mergeImage, computeUV } = require('./util');
...
module.exports = (Gvo) => {
  ...
  function createMyTube(pointsArr) {
    ...
    // 模拟管线运动动画
    mergeImage("./assets/img/1.png", "./assets/img/2.png", 1, 10, function (base64) {
  ...
  async function createTube(...pointsArr) {
    ...
    const base64 = await mergeImage("./assets/img/2.png", "./assets/img/1.png", 1, 7);
