// composer_fn.js
const { Vector2, ShaderMaterial, SpriteMaterial } = require('../lib/three.module');
const { EffectComposer } = require('../lib/EffectComposer');
const { ShaderPass } = require('../lib/ShaderPass');
const { RenderPass } = require('../lib/RenderPass');
const { CopyShader } = require('../lib/CopyShader');
const { UnrealBloomPass } = require('../lib/UnrealBloomPass');
const { FXAAShader } = require('../lib/FXAAShader');
// const { ClearPass } = require('../lib/ClearPass');
const { MaskPass, ClearMaskPass } = require('../lib/MaskPass');
